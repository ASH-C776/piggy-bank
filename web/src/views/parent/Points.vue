...
<template>
  <div class="page">
    ...
    <template v-else-if="selectedChild">
      ...
      <!-- 底部：临时加减分卡片 -->
      <GlassCard hover padding="16px" class="adjust-card" clickable label="临时加减分" @click="openAdjust">
...
.label { font-size: var(--fs-sm); color: var(--text-secondary); padding-left: var(--space-4); }
.selected-child {
  display: flex;
  align-items: center;
  gap: var(--space-10);
