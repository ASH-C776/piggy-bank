...
.icon-chip { display: flex; flex-direction: column; align-items: center; gap: var(--space-4); }
.icon-label { font-size: var(--fs-xs); color: var(--text-secondary); font-family: var(--font-cute); }
</style>
